...
def tail_points(opponent_score):
    ...
    # BEGIN PROBLEM 2
    tensNum, onesNum = 0, 0
    onesNum = opponent_score % 10
    opponent_score = opponent_score // 10
    tensNum = opponent_score % 10
    r = 2 * abs(tensNum - onesNum) + 1
    return r
    # END PROBLEM 2
...
def is_always_roll(strategy, goal=GOAL):
    ...
    # BEGIN PROBLEM 7
    score0, score1 = 0, 0
    r = strategy(score0, score1)
    while score0 < 100:
      score1 = 0
      while score1 < 100:
        if strategy(score0, score1) != r:
          return False
        score1 = score1 + 1
      score0 = score0 + 1
    return True
...
def square_strategy(score, opponent_score, threshold=12, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    t = 0
    if perfect_square(score + tail_points(opponent_score)):
       t = next_perfect_square(score + tail_points(opponent_score))
    else:
       t = score + tail_points(opponent_score)
